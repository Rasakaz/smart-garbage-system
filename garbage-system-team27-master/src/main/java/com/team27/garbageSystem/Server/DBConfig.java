 ...
 */
    ...
    private void ParseBinsAndAddToDB(){
        try{
            ...
            for(int i = 1; i < lines.size(); i++){
                ...
                mongoTemplate.save(new GarbageBin(i, Double.parseDouble(result[2]), Double.parseDouble(result[3]),InsertBinState()));
            }
    ...
    private String InsertBinState(){//dsfdavvasdvasdd
